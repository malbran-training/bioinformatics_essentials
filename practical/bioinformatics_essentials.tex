...
to allow us to start from an empty non-configured set up without conda
installed.
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
Command\PY{+w}{ }\PY{l+s+s1}{\PYZsq{}conda\PYZsq{}}\PY{+w}{ }not\PY{+w}{ }found.
\end{Verbatim}
\end{tcolorbox}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
bash\PY{+w}{ }\PYZti{}/miniconda3/miniconda.sh\PY{+w}{ }\PYZhy{}b\PY{+w}{ }\PYZhy{}u\PY{+w}{ }\PYZhy{}p\PY{+w}{ }\PYZti{}/miniconda3
\end{Verbatim}
\end{tcolorbox}
...
stored in \textasciitilde/miniconda3.
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
mkdir\PY{+w}{ }\PYZti{}/my\PYZus{}singularity
\PY{n+nb}{export}\PY{+w}{ }\PY{n+nv}{NXF\PYZus{}SINGULARITY\PYZus{}CACHEDIR}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}\PYZti{}/my\PYZus{}singularity\PYZdq{}}
\end{Verbatim}
\end{tcolorbox}
